        ...
        <div class="form-group">
          ...
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-md-8">
                <input type="number" name="faculty_id" id="faculty_id" class="form-control" />
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          <div class="input-daterange">
            <input type="text" name="attendance_date1" id="attendance_date1" class="form-control" placeholder="Select Date" readonly />
            <span id="error_attendance_date1" class="text-danger"></span>
          </div>
        </div>
...
// create chart
  $('#create_chart').click(function()
  {
    ...
    var attendance_date1 = $('#attendance_date1').val();
    var error = 0;
  ...
  // date for which chart is to be created is empty
    if(attendance_date1 == '')
    {
      $('#error_attendance_date1').text('Date is Required');
      error++;
    }
    else
    {
      $('#error_attendance_date1').text('');
    }
    ...
    if(error == 0)
    {
      ...
      window.open("chart1.php?action=attendance_report&course_id="+course_id+"&date="+attendance_date1);
    }
