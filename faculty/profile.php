		...
		<div class="card-body">
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-md-8">
						<input type="text" name="faculty_name" id="faculty_name" class="form-control" readonly/>
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-md-8">
						<textarea name="faculty_address" id="faculty_address" class="form-control" readonly></textarea>
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-md-8">
						<input type="text" name="faculty_emailid" id="faculty_emailid" class="form-control" readonly />
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-md-8">
						<input type="text" name="faculty_qualification" id="faculty_qualification" class="form-control" readonly/>
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-md-8">
						<select name="faculty_course_id" id="faculty_course_id" class="form-control" readonly>
